...
class SearchMethod:
	...
	@torch.no_grad()
	def greedy_search(self, decoder, tgt_embed, src_pad_mask, encoder_outputs, max_length, source):
	...
	@torch.no_grad()
	def beam_search(self, decoder, tgt_embed, src_pad_mask, encoder_outputs, max_length, source):
