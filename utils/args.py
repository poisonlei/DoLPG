...
def get_data_config(parser):
	...
	parser.add_argument('--vocab', type=str, default='./data/vocab/vocab.share')
	parser.add_argument('--train_file', type=str, default='./data/preprocess/para.pair')
...
def get_checkpoint_config(parser):
	...
	parser.add_argument('--restore_file', type=str, default='./data/checkpoint/checkpoint.pkl')
...
def get_generate_config():
	...
	parser = get_model_config(parser)
	parser.add_argument('--cuda_num', type=str, default='0', nargs='+')
	parser.add_argument('--file', type=str, default='./data/preprocess/sent.pt')
	parser.add_argument('--raw_file', type=str, default=None)
	parser.add_argument('--ref_file', type=str, default='./data/comb/test.comb')
	parser.add_argument('--max_length', type=int, default=300)
	parser.add_argument('--max_tokens', type=int, default=10000)
	parser.add_argument('--vocab', type=str, default='./data/vocab/vocab.share')
	parser.add_argument('--model_path', type=str, default='./data/checkpoint/checkpoint.pkl')
	parser.add_argument('--output_path', type=str, default='./data/generate')
...
def get_preprocess_config():
	parser = argparse.ArgumentParser()
	# # train (If you want to run train, comment test, uncomment train)
	parser.add_argument('--vocab', type=str, default='./data/vocab/vocab.share')
	parser.add_argument('--target', type=str, default='./data/comb/train.comb')
	parser.add_argument('--source', type=str, default='./data/comb/train.pesu.comb')
	parser.add_argument('--graph', type=str, default='./data/graph/train.graph')
	parser.add_argument('--save_file', type=str, default='./data/preprocess/para.pair')

	# # test (If you want to run test, comment train, uncomment test)
	# parser.add_argument('--vocab', type=str, default='./data/vocab/vocab.share')
	# parser.add_argument('--target', type=str, default=None)
	# parser.add_argument('--source', type=str, default='./data/comb/test.comb')
	# parser.add_argument('--graph', type=str, default='./data/graph/test.graph')
	# parser.add_argument('--save_file', type=str, default='./data/preprocess/sent.pt')
